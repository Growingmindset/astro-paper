...
The market just wrapped up one of the longest winning streaks in decades while breadth quietly deteriorated beneath the surface. We kept printing all-time highs even as more stocks declined than advanced—a negative divergence we haven’t seen structurally since 1996.
...
*   **IGV vs. Zillow:** Software continues to heavily lead, but Zillow is real estate tech that is lagging behind and has not followed trends—it is acting like a classic lagger.
*   **KWEB vs. Software:** Chinese tech is correlated with US software, though trailing on a lag. Look for signs of Chinese tech playing catch-up here.
*   **Metals vs. Chips:** A tightly bound relationship between silver, copper, and semiconductor demand, though macro forces are keeping them at a crossroads.
...
*   **Zillow (Z):** Playing the software lagger thesis behind IGV. If software rotation holds, Z catches up late. Looking at the low-to-mid $40s for a July swing, or targeted August options strikes under $50.
*   **Netflix (NFLX):** Another high-beta software lagger. Looking at July calls, keeping it conservative with strikes capped at $110 while waiting for macro rotation confirmation.
*   **Apple (AAPL):** Quiet, overlooked rotation momentum here. It sold off Friday on broad index exhaustion, which creates a solid entry opportunity if capital broadens out away from chips.
*   **Intuit (INTU):** A stellar long-term candidate. It’s sitting in a well-defined consolidation box. I am content to let it build a proper base here and look for entries on any further localized weakness.
*   **META (Event Play):** A high-conviction "drop-and-pop" setup. The judge's ruling on the social media addiction lawsuit drops sometime after the June 12th closing statements. A negative ruling won't hit a jury, but it risks becoming their "Cigarette Moment"—opening up massive future liabilities. A legal loss could trigger a sharp, short-term panic drop, creating a massive buying opportunity for a bounce on an otherwise lagging mega-cap name.
*   **CBOE / CME (Bounce Play):** The recent correction was a swift overreaction to the approval of perpetual futures. With traditional options volume printing all-time highs, this drop looks like structural exhaustion ripe for a bounce.
*   **S / CIBR (The Next Wave):** LEAPs on SentinelOne could be a hitter. The quiet signing of federal AI security initiatives signals that the next massive wave of government spending is headed toward defensive AI layers. Watching for near-term pullbacks to layer in shorter-term tactical positions.
*   **SLV / CPER:** The core debasement thesis remains fully intact based on expanding ISM manufacturing data and rising prices paid. Dollar strength is keeping a lid on metals for now, but any easing of the dollar's grip will likely trigger an aggressive, explosive breakout. Watching August silver targets closely.
